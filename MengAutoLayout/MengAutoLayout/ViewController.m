...
- (NSArray *)titles {
    if (!_titles) {
        _titles = @[@"UITextView根据内容自适应高度", @"UIScrollView问题", @"UIScrollView contentSize根据子视图确定", @"UITableViewCell自适应高度", @"查看约束", @"动画", @"安全区域", @"基于其他视图宽高比例的约束", @"批量布局子视图", @"批量连接视图", @"直接调用系统方法操作约束", @"使用iOS 9 api"];
    }
    return _titles;
}
